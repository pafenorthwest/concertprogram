        ...
        <tr>
            ...
            <td>
                {#if editing.id === composer.id}
                    <input type="text" value = {editing.printed_name} on:input={(event) => handleInputChange(event, 'full_name')} />
                {:else}
            ...
            <td>
                {#if editing.id === composer.id}
                    <input type="text" value = {editing.years_active} on:input={(event) => handleInputChange(event, 'full_name')} />
                {:else}
