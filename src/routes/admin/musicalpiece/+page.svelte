...
<table class="table">
    ...
    {#each data.musicalPieces as musicalPiece}
        <tr>
            ...
            <td>
                {#if editing.id === musicalPiece.id}
                    <input type="text" value = {editing.first_composer_id} on:input={(event) => handleInputChange(event, 'first_composer_id')} />
                {:else}
            ...
            <td>
                {#if editing.id === musicalPiece.id}
                    <input type="text" value = {editing.all_movements} on:input={(event) => handleInputChange(event, 'all_movements')} />
                {:else}
            ...
            <td>
                {#if editing.id === musicalPiece.id}
                    <input type="text" value = {editing.second_composer_id} on:input={(event) => handleInputChange(event, 'second_composer_id')} />
                {:else}
            ...
            <td>
                {#if editing.id === musicalPiece.id}
                    <input type="text" value = {editing.third_composer_id} on:input={(event) => handleInputChange(event, 'third_composer_id')} />
                {:else}
