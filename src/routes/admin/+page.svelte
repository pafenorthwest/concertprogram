...
{:else}
    ...
    <form id="full" class="inline-add" method="POST" action="?/add" use:enhance={handleFormResponse}>
        <div class="form-group">
            ...
            <input type="text" id="composer-name-piece-1" name="composer-name-piece-1" maxlength="80" required>
            <label for="composer-years-piece-1">Composer Years Active, Musical Piece 1:</label>
            <input type="text" id="composer-years-piece-1" name="composer-years-piece-1" maxlength="80" required>
