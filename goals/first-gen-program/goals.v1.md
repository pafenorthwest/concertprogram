...
1. A button labeled `CSV` replaces the current text link and still downloads CSV.
...
- [G1] The admin page renders a button labeled `CSV` instead of the existing text link, and activating it still triggers a CSV file download.
